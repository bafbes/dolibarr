...
else
{
	...
	if ($action == 'create')
	{
		...
		// Company
		print '<tr><td id="tdcompany">'.$langs->trans("Structure").'</td><td><input type="text" name="societe" class="minwidth300" maxlength="128" value="'.(GETPOSTISSET('societe') ? GETPOST('societe', 'alphanohtml') : $object->company).'"></td></tr>';
