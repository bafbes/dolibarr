...
else
{
    ...
    if ($resql)
    {
    	...
    	else
    	{
			...
			if (empty($conf->global->MAIN_HIDESELECTFIELDS4PRODUCTS) || $user->admin) print_liste_field_titre($selectedfields, $_SERVER["PHP_SELF"],"",'','','align="right"',$sortfield,$sortorder,'maxwidthsearch ');
            print '<td>';
            print "</tr>\n";
