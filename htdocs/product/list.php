...
else
{
    ...
    if ($resql)
    {
    	...
    	else
    	{
            ...
            if( empty($conf->global->MAIN_HIDESELECTFIELDS4PRODUCTS)) print_liste_field_titre($selectedfields, $_SERVER["PHP_SELF"],"",'','','align="right"',$sortfield,$sortorder,'maxwidthsearch ');
            else print '<td></td>';
			print "</tr>\n";
