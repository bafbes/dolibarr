...
/**
 *      \file       laforet/laforetbankaccount_script.php
 *		\ingroup    laforet
...
// Examples for manipulating class laforetbankaccount_class
require_once(DOL_DOCUMENT_ROOT."/../laforet/laforetbankaccount.class.php");
$myobject=new Laforetbankaccount($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."laforetbankaccount";
